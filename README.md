...
## Instalação
### Modo fácil
1. [Clique aqui](https://github.com/renandecarlo/geraldin-bot/releases/download/v1.0-beta/geraldin-bot.v1.0-beta.zip) para fazer o download do programa e descompacte o arquivo.
